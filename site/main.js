...
const pt = Object.freeze({
  ...
  terminalNote: "A URL do repositório e os comandos exatos devem ser conferidos com o pacote publicado antes do lançamento. Fixtures e este site estático dispensam chave.",
  ...
  videoBody: "O guia em inglês planejado cobre instalação local, pergunta tipada, prévia com fixture, execução real explícita e log de evidências. Quando publicado, a narração e as legendas serão rotuladas como Gemini TTS.",
  videoPending: "O vídeo verificado ainda não foi incluído. O player aparece somente quando o arquivo estiver presente.",
  transcriptLink: "Ler a transcrição ↗",
  videoFrameNote: "Mídia local provisória · esperado: site/media/jev-flow-walkthrough.webm",
