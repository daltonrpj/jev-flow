...
const PACKS = {
  ...
  en: {
    ...
    staticCopy: {
      ...
      'Fluxo': 'Flow', 'Raciocínio': 'Reasoning', 'Editar': 'Edit', 'Teste': 'Test', '🧪 Simulador': '🧪 Simulator',
      'Conexões': 'Connections', 'Ferramentas do flow': 'Flow tools', 'Modo de representação': 'Canvas mode',
      'Layout do grafo': 'Graph layout', 'Idioma': 'Language', 'velocidade do replay': 'Replay speed',
      'editar input': 'Edit input', 'ocultar input': 'Hide input', 'rodar': 'Run', 'simular': 'Simulate',
      'Fixtures reproduzíveis': 'Reproducible fixtures',
      'Salve entradas nomeadas no rascunho para repetir um teste sem alterar histórico.': 'Save named inputs in the draft to repeat a test without changing history.',
      'nenhuma fixture selecionada': 'no fixture selected', 'fixture selecionada': 'Selected fixture', 'nova fixture': 'new fixture',
      '＋ nova': '＋ new', 'remover': 'remove', 'nome': 'Name', 'Salvar fixture': 'Save fixture',
      'ex.: cobrança urgente': 'e.g. urgent billing request',
      'Exemplo shipped somente leitura: selecione e edite o input para testar, depois use “Duplicar para editar” para salvar fixtures.': 'Read-only shipped example: edit the input to test, then use “Duplicate to edit” to save fixtures.',
      'pronto para testar': 'ready to test',
      'edite o input se necessário e rode o flow; sem chave Jev, a simulação é determinística e não grava histórico.': 'edit the input and run the flow; local simulation is deterministic and does not call Jev or write history.',
      'SIMULADO': 'SIMULATED', 'SIMULAÇÃO': 'SIMULATION', 'cenário sintético · sem chamada Jev': 'synthetic fixture · no Jev call',
      'operação concluída': 'operation complete', 'operação com falha': 'operation failed', 'caminho:': 'Path:',
      'passos:': 'Steps:', 'duração da simulação local:': 'Local simulation duration:', 'julgamentos:': 'Judgments:',
      'tokens de entrada:': 'Input tokens:', 'custo real:': 'Actual cost:', 'sem chamada Jev': 'no Jev call',
      'concluído · valores redigidos': 'complete · values redacted', 'duração indisponível': 'duration unavailable',
      'caminho não informado': 'path not provided', 'saída não informada': 'output not provided',
      'classificar': 'classify', 'rotear': 'route', 'fila': 'queue', 'urgente': 'urgent',
      'Último teste: ': 'Last test: ', 'O canvas mostra a amostra inicial; detalhes no painel Teste.': 'The canvas shows the initial sample; details are in the Test panel.',
    },
  },
  es: {
